    ...
    <>
      <div className="site-filters style-1 clearfix center m-b40">
        <ul className="filters">
          ...
          <li className={`btn ${filter === "web_design" ? "active" : ""} cap`}>
            <a
          ...
          <li className={`btn ${filter === "web_development" ? "active" : ""} cap`}>
            <a
          ...
          <li className={`btn ${filter === "branding" ? "active" : ""} cap`}>
            <a
          ...
          <li className={`btn ${filter === "mobile_app" ? "active" : ""} cap`}>
            <a
          ...
          <li className={`btn ${filter === "seo" ? "active" : ""} cap`}>
