        ...
        <>
            ...
            >
				<div className="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.1s">
					<div className="dlab-team style-2 m-b10">
						<div className="dlab-media">
							<img className="" src="images/team/small/Rakesh1.jpeg" alt=""/>
						</div>
						<div className="dlab-content">
							<div className="clearfix">
								<h3 className="dlab-name"><a href="/team-3">Rakesh Dadhich <br /></a></h3>
				...
				<div className="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
					<div className="dlab-team style-2 m-b10">
						<div className="dlab-media">
							<img className={c.img1} src="images/team/small/Praveen1.jpeg" alt=""/>
						</div>
						<div className="dlab-content">
							<div className="clearfix">
								<h3 className="dlab-name"><a href="/team-3">Praveen Dadhich <br /></a></h3>
								<span className="dlab-position">Director</span>
							</div>
						</div>
					</div>
				...
				<div className="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
					<div className="dlab-team style-2 m-b10">
						<div className="dlab-media">
							<img className={c.img1} src="images/team/small/Bina.jpeg" alt=""/>
						</div>
						<div className="dlab-content">
							<div className="clearfix">
								<h3 className="dlab-name"><a href="/team-3">Bina Kunadiya <br /></a></h3>
				...
				<div className="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
					<div className="dlab-team style-2 m-b10">
						<div className="dlab-media">
							<img className={c.img1} src="images/team/small/Diwanshu.jpeg" alt=""/>
						</div>
						<div className="dlab-content">
							<div className="clearfix">
								<h3 className="dlab-name"><a href="/team-3">Diwanshu Midha <br /></a></h3>
								<span className="dlab-position">Full Stack Developer</span>
							</div>
						</div>
					</div>
				...
				<div className="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
					<div className="dlab-team style-2 m-b10">
						<div className="dlab-media">
							<img className={c.img1} src="images/team/small/Sartaj.jpg" alt=""/>
						</div>
						<div className="dlab-content">
							<div className="clearfix">
								<h3 className="dlab-name"><a href="/team-3">Sartaj Saifi <br /></a></h3>
								<span className="dlab-position">Full Stack Developer</span>
							</div>
						</div>
					</div>
				...
				<div className="item wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
					<div className="dlab-team style-2 m-b10">
						<div className="dlab-media">
							<img className={c.img1} src="images/team/small/Surjeet1.jpeg" alt=""/>
						</div>
						<div className="dlab-content">
							<div className="clearfix">
								<h3 className="dlab-name"><a href="/team-3">Surjeet Chaudhary <br /></a></h3>
